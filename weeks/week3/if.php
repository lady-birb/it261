...
if ($new_temp <= 60) {
 ...
 $salary = 95000;
 $sales = 148000;
 //if sales is equal or less than 99999, then you do not receive a bonus

 //if sales is equal or less than 11,999, then you will receive 5%
