...
$cars = array('toyota', 'ford', 'suburu', 'audi', 'bmw', 'mercedes', 'lexux');
...
<p>If post wines is not empty, take post wines and implode them, and create a new variable names $my_wines</p>
