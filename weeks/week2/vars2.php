...
echo '<br>';
$name = 'Olga';
$name .= ' Smith'; //joins to variable above
echo $name;
...
echo '<br>';
$x = 20;
$x += 5; //take x which is 20 and add 5
echo $x;
echo '<br>';
$x = 100;
$x /= 10;
...
echo date('l');
echo '<br>';
echo date("l jS \of F Y h:i:s A"); //date function
echo '<br>';
echo date("l jS \of F Y h:i A"); //F = the month
echo '<br>';
...
$fruit[] = 'bananas'; //the square brackets signal that this will be an array
$fruit[] = 'cherries';
$fruit[] = 'melon';
$fruit[] = 'kiwi';
$fruit[] = 'oranges';
...
echo $fruit;
echo '<br>';
echo $fruit[2]; //remember, numbering in php starts with 0!!
